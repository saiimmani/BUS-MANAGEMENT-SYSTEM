...
public class BUS extends JFrame implements ActionListener {
          ...
          if(UserField.getText()!= null && PassField.getText()!=null)
           {
                    try
                    {
                        ...
                        try (Connection conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/sasi","root","sAsi@123")) {
  ...
  class searchPAge extends JFrame implements ActionListener{
   ...
   JComboBox FromCB,DestCB;
    ...
    String a1[]={"source","hyderbad","guntur","vijaywada","tirupathi","vizianagram","bangalore"
    };
     String a2[]={"destination","hyderbad","guntur","vijaywada","tirupathi","vizianagaram","banglore"};
       ...
       add(id);
        ...
        if(e.getSource()==search){
                    try
                     {
                        Class.forName("com.mysql.cj.jdbc.Driver");
                        Connection conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/sasi","root","sAsi@123");
       ...
       if(e.getSource() == del)
        {
            try
            {
               int a =Integer.parseInt(box.getText());
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                 java.sql.Connection c= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/sasi","root","sAsi@123");
